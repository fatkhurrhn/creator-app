...
const NavCreator = ({ children }) => {
  ...
  const navItems = [
    ...
    { path: '/quotes', icon: 'ri-chat-quote-line', activeIcon: 'ri-chat-quote-fill', label: 'Quotes', isNew: true },
    { path: '/store', icon: 'ri-store-line', activeIcon: 'ri-store-fill', label: 'Store' },
    { path: '/mentahan', icon: 'ri-folders-line', activeIcon: 'ri-folders-fill', label: 'Mentahan', isNew: true },
    { path: '/other', icon: 'ri-apps-line', activeIcon: 'ri-apps-fill', label: 'More' },
  ];
