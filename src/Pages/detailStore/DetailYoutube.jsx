...
export default function StoreYT() {
  ...
  const handleSubmit = (e) => {
    ...
    const message = `*Detail Pesanan Youtube*\n\n` +
    ...
    <div className="font-sans bg-white min-h-screen">
      ...
      <main className="max-w-4xl mx-auto px-4 py-2 pb-[110px]">
        ...
        <div className="text-center">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-800">Youtube Pricelist</h1>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg p-5 w-full max-w-md">
              <div className="mb-4 p-3 bg-gray-100 rounded text-gray-800">
                ...
                <p>Youtube {selected.category} {selected.duration}</p>
              </div>
